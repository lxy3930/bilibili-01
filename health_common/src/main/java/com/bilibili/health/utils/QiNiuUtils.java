package com.bilibili.health.utils;
...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "qqB1VsBJRMTE00fSXnhKrBsQzPgi-9jCjRJwLBcY";
    private static final String SECRETKEY = "vVko8FjXBK9UySlMptlinkhcAbPOA1CalwQ_YObX";
    private static final String BUCKET = "bilibili-01";
    public static final String DOMAIN = "http://qmnvy1ed1.hn-bkt.clouddn.com/";
    private static long logTimestemp4Toke = 01;
